...
public class OpenAIClient {
     ...
     * @throws OpenAIException if the request to OpenAI fails or the
    ...
    public String askOpenAI(String prompt) {
        ...
        try {
            ...
            logger.error("Failed to obtain a chat completion from OpenAI.", ex);

            throw new OpenAIException(
                    "Failed to communicate with the OpenAI chat completions API",
                    ex);
        }
    }
    ...
    public List<Float> getEmbedding(String text) {
        ...
        try {
            ...
            logger.error("Failed to generate embedding using OpenAI.", ex);

            throw new OpenAIException(
                    "Failed to communicate with the OpenAI embeddings API",
                    ex);
        }
    }
}